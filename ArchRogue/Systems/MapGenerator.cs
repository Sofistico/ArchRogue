...
namespace ArchRogue.Systems
{
    public class MapGenerator
    {
        ...
        public DungeonMap CreateMap()
        {
            ...
            {
                //Determine the size and width of the rooms randomly
                ...
                //Check to see if the room rectangle intescets with any other room
                bool newRoomIntesects = _map.Rooms.Any(room => newRoom.Intersects(room));
            ...
            //Call right before calling player
            CreateStairs();
        ...
        //Carve some tunnel along the x axis
        ...
        //Carve some tunnel along the y axis
